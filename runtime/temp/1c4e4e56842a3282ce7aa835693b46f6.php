<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\phpStudy\PHPTutorial\WWW\thy-cms\public/../application/index\view\article\edit.html";i:1558268250;s:81:"D:\phpStudy\PHPTutorial\WWW\thy-cms\application\index\view\public\head_admin.html";i:1554637412;s:77:"D:\phpStudy\PHPTutorial\WWW\thy-cms\application\index\view\public\footer.html";i:1556348597;s:78:"D:\phpStudy\PHPTutorial\WWW\thy-cms\application\index\view\public\tinymce.html";i:1561042945;}*/ ?>
<!DOCTYPE HTML>
		...
		<form class="layui-form layui-form-pane" id="edit_form" enctype="multipart/form-data">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="title" lay-verType="alert" lay-verify="required" placeholder="请输入标题(必填)" value="<?php echo $list['title']; ?>" autocomplete="on" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					...
					<div class="input_file_style input_file_style_on">
						<div class="input_file" name="img1">
							<img src="/public/uploads/<?php echo $list['img1']; ?>" class="needContain" alt="">
						</div>
					<?php else: ?>
					...
					<input type="text" id="img1" value="<?php echo $list['img1']; ?>" name="img1" hidden>


					<?php if($list['img2'] != ''): ?>
					<div class="input_file_style input_file_style_on">
						<div class="input_file" name="img2">
							<img src="/public/uploads/<?php echo $list['img2']; ?>" class="needContain" alt="">
						</div>
					<?php else: ?>
					<div class="input_file_style">
						<div class="input_file" name="img2">
                    ...
                    <input type="text" id="img2" value="<?php echo $list['img2']; ?>" name="img2" hidden>
					...
					<div class="input_file_style input_file_style_on">
						<div class="input_file" name="img3">
							<img src="/public/uploads/<?php echo $list['img3']; ?>" class="needContain" alt="">
						</div>
					<?php else: ?>
					<div class="input_file_style">
						<div class="input_file" name="img3">
                    ...
                    <input type="text" id="img3" value="<?php echo $list['img3']; ?>" name="img3" hidden>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<!--<select name="pid">-->
						<!--<option value="<?php echo $list['pid']; ?>"><?php echo $list['pname']; ?></option>-->
						<!--<?php echo $tree; ?>-->
					<!--</select>-->
					<input type="text" value="<?php echo $list['pname']; ?>"  placeholder="请选择分类(必填)"  readonly class="layui-input pid_mask">
					<input type="text" name="pid" lay-verType="alert" lay-verify="required" value="<?php echo $list['pid']; ?>" hidden class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div id="classTree" pids="<?php echo $list['pid']; ?>" style="display: none">
				<?php echo $tree; ?>
			</div>
		</form>
	</div>
    ...
    $(function () {
        $(".pid_mask").click(function () {
            ...
            $(".tree_son").each(function () {
                var pidsArr=$("#classTree").attr("pids").split(",");
                if(pidsArr.includes($(this).attr("id"))){
        ...
        layui.use('form', function(){
            ...
            form.on('submit(formDemo)', function(){
                ...
                $.ajax({
                    url:"/public/article/editArticle?id=<?php echo $list['id']; ?>",
                    data:art_form,
                    type:"post",
                    async : false,
                    contentType: false,
